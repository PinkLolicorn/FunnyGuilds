package net.dzikoysk.funnyguilds.concurrency.requests.dummyimport
...
class DummyUpdateUserRequest(private val user: User) : DefaultConcurrencyRequest() {
    override fun execute() {
        user.cache.dummy.updateScore(user)
    }
}