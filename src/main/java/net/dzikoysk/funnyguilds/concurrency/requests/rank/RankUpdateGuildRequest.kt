package net.dzikoysk.funnyguilds.concurrency.requests.rankimport
...
class RankUpdateGuildRequest(private val guild: Guild) : DefaultConcurrencyRequest() {
    @Throws(Exception::class)
    override fun execute() {
        RankManager.Companion.getInstance().update(guild)
    }
}