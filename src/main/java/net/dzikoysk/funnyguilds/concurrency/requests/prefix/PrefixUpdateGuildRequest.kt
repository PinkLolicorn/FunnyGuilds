package net.dzikoysk.funnyguilds.concurrency.requests.prefiximport
...
class PrefixUpdateGuildRequest(private val user: User, private val guild: Guild) : DefaultConcurrencyRequest() {
    override fun execute() {
        val prefix = user.cache.individualPrefix ?: return
