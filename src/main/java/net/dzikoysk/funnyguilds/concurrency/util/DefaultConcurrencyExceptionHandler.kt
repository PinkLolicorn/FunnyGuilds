...
class DefaultConcurrencyExceptionHandler : ConcurrencyExceptionHandler {
    override fun handleException(exception: Exception?) {
        FunnyGuilds.Companion.getPluginLogger().error("An error occurred while handling concurrent request", exception)
    }
}