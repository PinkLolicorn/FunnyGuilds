...
object UserValidation {
    fun requireUserByName(name: String?): User {
        return UserUtils.get(name, true) ?: throw ValidationException(FunnyGuilds.Companion.getInstance().getMessageConfiguration().generalNotPlayedBefore)
    }
}