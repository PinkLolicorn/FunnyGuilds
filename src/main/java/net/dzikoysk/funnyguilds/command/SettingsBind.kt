...
@FunnyComponent
internal class SettingsBind : Bind {
    override fun accept(injectorResources: Resources) {
        injectorResources.on(PluginConfiguration::class.java).assignInstance { FunnyGuilds.Companion.getInstance().getPluginConfiguration() }
    }
}