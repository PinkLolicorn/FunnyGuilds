...
@FunnyComponent
internal class OwnerValidator : Validator<IsOwner?, User, ValidationException?> {
    @Throws(ValidationException::class)
    override fun validate(context: Context, annotation: IsOwner?, property: Property, user: User): Boolean {
        OwnerValidator.Companion.MEMBER_VALIDATOR.isMember(user)
        if (!user.isOwner) {
    ...
    override fun getAnnotation(): Class<IsOwner?>? {
        return IsOwner::class.java
    }
