...
internal class FunnyGuildsExceptionHandler(private val funnyGuilds: FunnyGuilds) : ExceptionHandler<Exception?> {
    override fun getExceptionType(): Class<Exception?>? {
        return Exception::class.java
    }

    override fun apply(o: Exception): Boolean {
        FunnyGuilds.Companion.getPluginLogger().error("An exception has been caught while executing the command", o)
        return true
    }
}