...
class DeleteAdminCommand {
    ...
    fun execute(messages: MessageConfiguration, sender: CommandSender, args: Array<String?>) {
        ...
        if (!SimpleEventHandler.handle(GuildDeleteEvent(AdminUtils.getCause(admin), admin, guild))) {
            return
        }
        ...
        val formatter = Formatter()
            ...
            .register("{PLAYER}", sender.name)
        guild.owner!!.sendMessage(formatter.format(messages.adminGuildBroken))
