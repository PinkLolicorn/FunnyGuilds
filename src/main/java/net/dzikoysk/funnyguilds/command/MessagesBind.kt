...
@FunnyComponent
internal class MessagesBind : Bind {
    override fun accept(injectorResources: Resources) {
        injectorResources.on(MessageConfiguration::class.java).assignInstance { FunnyGuilds.Companion.getInstance().getMessageConfiguration() }
    }
}