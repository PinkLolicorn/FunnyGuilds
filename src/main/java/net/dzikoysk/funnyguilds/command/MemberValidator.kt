...
@FunnyComponent
internal class MemberValidator : Validator<IsMember?, User, ValidationException?> {
    @Throws(ValidationException::class)
    override fun validate(context: Context, annotation: IsMember?, property: Property, user: User): Boolean {
    ...
    override fun getAnnotation(): Class<IsMember?>? {
        return IsMember::class.java
    }
