...
@FunnyComponent
internal class GuildsCompleter : Completer {
    override fun apply(context: Context, prefix: String, limit: Int): List<String> {
        return CommandUtils.collectCompletions(GuildUtils.getGuilds(), prefix, limit, { initialCapacity: Int? ->
            ArrayList(
                initialCapacity!!
            )
        }) { obj: Guild? -> obj.getTag() }
    }
