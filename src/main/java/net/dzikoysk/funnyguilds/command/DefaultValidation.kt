...
object DefaultValidation {
    fun whenNull(value: Any?, message: Supplier<Any?>) {
        if (value == null) {
            throw ValidationException(Objects.toString(message.get()))
        }
    }

    fun whenNull(value: Any?, message: String?) {
        if (value == null) {
            throw ValidationException(message)
        }
    }

    fun `when`(flag: Boolean, message: String?) {
        if (flag) {
            throw ValidationException(message)
        }
    }

    fun `when`(flag: Boolean, message: Supplier<Any?>) {
        if (flag) {
            throw ValidationException(Objects.toString(message.get()))
        }
    }
