...
class KillsChangeEvent(eventCause: EventCause?, rank: Rank?, doer: User?, change: Int) : RankChangeEvent(eventCause, rank, doer, change) {
    override fun getHandlers(): HandlerList {
        return handlerList
    }

    override val defaultCancelMessage: String
        get() = "[FunnyGuilds] Kills change has been cancelled by the server!"
