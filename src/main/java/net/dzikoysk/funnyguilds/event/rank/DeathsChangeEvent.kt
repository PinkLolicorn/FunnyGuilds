...
class DeathsChangeEvent(eventCause: EventCause?, rank: Rank?, doer: User?, change: Int) : RankChangeEvent(eventCause, rank, doer, change) {
    override fun getHandlers(): HandlerList {
        return handlerList
    }

    override val defaultCancelMessage: String
        get() = "[FunnyGuilds] Deaths change has been cancelled by the server!"
