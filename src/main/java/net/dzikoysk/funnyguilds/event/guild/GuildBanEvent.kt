...
class GuildBanEvent(eventCause: EventCause?, doer: User?, guild: Guild?, val time: Long, val reason: String) : GuildEvent(eventCause, doer, guild) {
    override fun getHandlers(): HandlerList {
        return handlerList
    }

    override val defaultCancelMessage: String
        get() = "[FunnyGuilds] Guild ban has been cancelled by the server!"
