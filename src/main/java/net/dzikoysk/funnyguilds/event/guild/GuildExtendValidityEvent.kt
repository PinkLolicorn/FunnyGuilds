...
class GuildExtendValidityEvent(eventCause: EventCause?, doer: User?, guild: Guild?, val extendTime: Long) : GuildEvent(eventCause, doer, guild) {
    override fun getHandlers(): HandlerList {
        return handlerList
    }

    override val defaultCancelMessage: String
        get() = "[FunnyGuilds] Guild validity extension has been cancelled by the server!"
