...
class GuildMemberLeaveEvent(eventCause: EventCause?, doer: User?, guild: Guild?, member: User) : GuildMemberEvent(eventCause, doer, guild, member) {
    override fun getHandlers(): HandlerList {
        return handlerList
    }

    override val defaultCancelMessage: String
        get() = "[FunnyGuilds] Member leave has been cancelled by the server!"
