...
class GuildDeleteEvent(eventCause: EventCause?, doer: User?, guild: Guild?) : GuildEvent(eventCause, doer, guild) {
    override fun getHandlers(): HandlerList {
        return handlerList
    }

    override val defaultCancelMessage: String
        get() = "[FunnyGuilds] Guild deletion has been cancelled by the server!"
