...
class GuildPreRenameEvent(eventCause: EventCause?, doer: User?, guild: Guild?, val oldName: String?, val newName: String) : GuildEvent(eventCause, doer, guild) {
    override fun getHandlers(): HandlerList {
        return handlerList
    }

    override val defaultCancelMessage: String
        get() = "[FunnyGuilds] Guild renaming has been cancelled by the server!"
