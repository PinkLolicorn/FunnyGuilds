...
class GuildPreCreateEvent(eventCause: EventCause?, doer: User?, guild: Guild?) : GuildEvent(eventCause, doer, guild) {
    override fun getHandlers(): HandlerList {
        return handlerList
    }

    override val defaultCancelMessage: String
        get() = "[FunnyGuilds] Guild creation has been cancelled by the server!"
