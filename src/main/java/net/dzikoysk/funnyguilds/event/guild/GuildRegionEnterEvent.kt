...
class GuildRegionEnterEvent(cause: EventCause?, doer: User?, guild: Guild?) : GuildEvent(cause, doer, guild, true) {
    override fun getHandlers(): HandlerList {
        return handlerList
    }

    override val defaultCancelMessage: String
        get() = "[FunnyGuilds] Guild region enter has been cancelled by the server!"
