...
class GuildPreTagChangeEvent(eventCause: EventCause?, doer: User?, guild: Guild?, val oldTag: String?, val newTag: String) : GuildEvent(eventCause, doer, guild) {
    override fun getHandlers(): HandlerList {
        return handlerList
    }

    override val defaultCancelMessage: String
        get() = "[FunnyGuilds] Changing guild tag has been cancelled by the server!"
