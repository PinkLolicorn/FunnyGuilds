...
class GuildBreakAllyEvent(eventCause: EventCause?, doer: User?, guild: Guild?, alliedGuild: Guild) : GuildAllyEvent(eventCause, doer, guild, alliedGuild) {
    override fun getHandlers(): HandlerList {
        return handlerList
    }

    override val defaultCancelMessage: String
        get() = "[FunnyGuilds] Alliance break has been cancelled by the server!"
