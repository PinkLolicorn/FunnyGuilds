...
org.bukkit.Locationimport org.bukkit.event.HandlerList
import java.lang.StackTraceElement

class GuildBaseChangeEvent(eventCause: EventCause?, doer: User?, guild: Guild?, val newBaseLocation: Location) : GuildEvent(eventCause, doer, guild) {
    override fun getHandlers(): HandlerList {
        return handlerList
    }

    override val defaultCancelMessage: String
        get() = "[FunnyGuilds] Guild base location change has been cancelled by the server!"
