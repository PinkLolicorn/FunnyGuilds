...
class GuiItem {
    ...
    private val consumer: Consumer<InventoryClickEvent>

    constructor(item: ItemStack) {
        this.item = item
        consumer = Consumer { ignored: InventoryClickEvent? -> }
    }

    constructor(item: ItemStack, consumer: Consumer<InventoryClickEvent>?) {
        this.item = item
        this.consumer = consumer ?: Consumer { a: InventoryClickEvent? -> }
    }
