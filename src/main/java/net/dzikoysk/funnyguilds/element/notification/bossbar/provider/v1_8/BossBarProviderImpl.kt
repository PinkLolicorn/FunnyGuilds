package net.dzikoysk.funnyguilds.element.notification.bossbar.provider.v1_8import
...
class BossBarProviderImpl(private val user: User) : BossBarProvider {
    companion object {
        private val ENTITY_CLASS: Class<*>? = null
        private val ENTITY_LIVING_CLASS: Class<*>? = null
        private val ENTITY_WITHER_CLASS: Class<*>? = null
        private val PACKET_PLAY_OUT_SPAWN_ENTITY_LIVING_CLASS: Class<*>? = null
        private val PACKET_PLAY_OUT_ENTITY_DESTROY_CLASS: Class<*>? = null
        private val PACKET_PLAY_OUT_ENTITY_TELEPORT_CLASS: Class<*>? = null
        private val ENTITY_WITHER_CONSTRUCTOR: Constructor<*>? = null
        private val PACKET_PLAY_OUT_SPAWN_ENTITY_LIVING_CONSTRUCTOR: Constructor<*>? = null
        private val PACKET_PLAY_OUT_ENTITY_DESTROY_CONSTRUCTOR: Constructor<*>? = null
        private val PACKET_PLAY_OUT_ENTITY_TELEPORT_CONSTRUCTOR: Constructor<*>? = null
        private val ENTITY_WITHER_SET_LOCATION: Method? = null
        private val ENTITY_WITHER_SET_INVISIBLE: Method? = null
        private val ENTITY_WITHER_SET_CUSTOM_NAME: Method? = null
        private val ENTITY_WITHER_GET_ID: Method? = null
        private val ENTITY_WITHER_MOT_X: Field? = null
        private val ENTITY_WITHER_MOT_Y: Field? = null
        private val ENTITY_WITHER_MOT_Z: Field? = null

        init {
            BossBarProviderImpl.Companion.ENTITY_CLASS = Reflections.getNMSClass("Entity")
            BossBarProviderImpl.Companion.ENTITY_LIVING_CLASS = Reflections.getNMSClass("EntityLiving")
            BossBarProviderImpl.Companion.ENTITY_WITHER_CLASS = Reflections.getNMSClass("EntityWither")
            BossBarProviderImpl.Companion.PACKET_PLAY_OUT_SPAWN_ENTITY_LIVING_CLASS = Reflections.getNMSClass("PacketPlayOutSpawnEntityLiving")
            BossBarProviderImpl.Companion.PACKET_PLAY_OUT_ENTITY_DESTROY_CLASS = Reflections.getNMSClass("PacketPlayOutEntityDestroy")
            BossBarProviderImpl.Companion.PACKET_PLAY_OUT_ENTITY_TELEPORT_CLASS = Reflections.getNMSClass("PacketPlayOutEntityTeleport")
            BossBarProviderImpl.Companion.ENTITY_WITHER_CONSTRUCTOR = Reflections.getConstructor(BossBarProviderImpl.Companion.ENTITY_WITHER_CLASS, Reflections.getNMSClass("World"))
            BossBarProviderImpl.Companion.PACKET_PLAY_OUT_SPAWN_ENTITY_LIVING_CONSTRUCTOR =
                Reflections.getConstructor(BossBarProviderImpl.Companion.PACKET_PLAY_OUT_SPAWN_ENTITY_LIVING_CLASS, BossBarProviderImpl.Companion.ENTITY_LIVING_CLASS)
            BossBarProviderImpl.Companion.PACKET_PLAY_OUT_ENTITY_DESTROY_CONSTRUCTOR =
                Reflections.getConstructor(BossBarProviderImpl.Companion.PACKET_PLAY_OUT_ENTITY_DESTROY_CLASS, IntArray::class.java)
            BossBarProviderImpl.Companion.PACKET_PLAY_OUT_ENTITY_TELEPORT_CONSTRUCTOR = Reflections.getConstructor(
                BossBarProviderImpl.Companion.PACKET_PLAY_OUT_ENTITY_TELEPORT_CLASS,
            ...
            BossBarProviderImpl.Companion.ENTITY_WITHER_SET_LOCATION = Reflections.getMethod(
                BossBarProviderImpl.Companion.ENTITY_WITHER_CLASS,
                "setLocation",
                Double::class.javaPrimitiveType!!, Double::class.javaPrimitiveType!!, Double::class.javaPrimitiveType!!, Float::class.javaPrimitiveType!!, Float::class.javaPrimitiveType!!
            )
            BossBarProviderImpl.Companion.ENTITY_WITHER_SET_INVISIBLE = Reflections.getMethod(
                BossBarProviderImpl.Companion.ENTITY_WITHER_CLASS,
                "setInvisible",
                Boolean::class.javaPrimitiveType!!
            )
            BossBarProviderImpl.Companion.ENTITY_WITHER_SET_CUSTOM_NAME = Reflections.getMethod(
                BossBarProviderImpl.Companion.ENTITY_WITHER_CLASS,
                "setCustomName",
                (if (Reflections.USE_PRE_13_METHODS) String::class.java else Reflections.getNMSClass("IChatBaseComponent"))!!
            )
            BossBarProviderImpl.Companion.ENTITY_WITHER_GET_ID = Reflections.getMethod(BossBarProviderImpl.Companion.ENTITY_WITHER_CLASS, "getId")
            BossBarProviderImpl.Companion.ENTITY_WITHER_MOT_X = Reflections.getField(BossBarProviderImpl.Companion.ENTITY_CLASS, "motX")
            BossBarProviderImpl.Companion.ENTITY_WITHER_MOT_Y = Reflections.getField(BossBarProviderImpl.Companion.ENTITY_CLASS, "motY")
            BossBarProviderImpl.Companion.ENTITY_WITHER_MOT_Z = Reflections.getField(BossBarProviderImpl.Companion.ENTITY_CLASS, "motZ")
        }
    }

    @Volatile
    private var bossBarHandleTask: BukkitTask? = null
    private var witherInstance: Any? = null
    private val currentSecond: AtomicInteger
    private var witherId = 0
    override fun sendNotification(text: String, options: BossBarOptions?, timeout: Int) {
        val player = user.player ?: return
        if (bossBarHandleTask != null) {
            bossBarHandleTask!!.cancel()
            removeBossBar(player)
            currentSecond.set(0)
        }
        createBossBar(player, text, timeout)
    }
    ...
    private fun createBossBar(player: Player, text: String, timeout: Int) {
        try {
            witherInstance = BossBarProviderImpl.Companion.ENTITY_WITHER_CONSTRUCTOR.newInstance(Reflections.getHandle(player.world))
            val witherLocation = player.location.add(player.location.direction.normalize().multiply(30))
            BossBarProviderImpl.Companion.ENTITY_WITHER_SET_LOCATION.invoke(
                witherInstance,
                witherLocation.x, witherLocation.y, witherLocation.z, witherLocation.yaw, witherLocation.pitch
            )
            BossBarProviderImpl.Companion.ENTITY_WITHER_SET_INVISIBLE.invoke(witherInstance, true)
            BossBarProviderImpl.Companion.ENTITY_WITHER_SET_CUSTOM_NAME.invoke(
                witherInstance, if (Reflections.USE_PRE_13_METHODS) text else NotificationUtil.createBaseComponent(text, false)
            )
            BossBarProviderImpl.Companion.ENTITY_WITHER_MOT_X.set(witherInstance, 0)
            BossBarProviderImpl.Companion.ENTITY_WITHER_MOT_Y.set(witherInstance, 0)
            BossBarProviderImpl.Companion.ENTITY_WITHER_MOT_Z.set(witherInstance, 0)
            witherId = BossBarProviderImpl.Companion.ENTITY_WITHER_GET_ID.invoke(witherInstance)
            val spawnPacket: Any = BossBarProviderImpl.Companion.PACKET_PLAY_OUT_SPAWN_ENTITY_LIVING_CONSTRUCTOR.newInstance(witherInstance)
            PacketSender.sendPacket(player, spawnPacket)
            bossBarHandleTask = Bukkit.getScheduler().runTaskTimerAsynchronously(FunnyGuilds.Companion.getInstance(), Runnable {
                if (currentSecond.getAndIncrement() >= timeout * 2) {
                    bossBarHandleTask!!.cancel()
                    removeBossBar(player)
            ...
            throw RuntimeException("Could not create boss bar", ex)
        }
    }
    ...
    private fun updateBossBar(player: Player) {
        try {
            val witherLocation = player.location.add(player.location.direction.normalize().multiply(30))
            val teleportPacket: Any = BossBarProviderImpl.Companion.PACKET_PLAY_OUT_ENTITY_TELEPORT_CONSTRUCTOR.newInstance(
                witherId,
                witherLocation.blockX * 32,
                witherLocation.blockY * 32,
                witherLocation.blockZ * 32,
                (witherLocation.yaw * 256 / 360).toInt().toByte(),
                (witherLocation.pitch * 256 / 360).toInt().toByte(),
                false
            )
            PacketSender.sendPacket(player, teleportPacket)
        } catch (ex: Exception) {
            throw RuntimeException("Could not send wither entity set location packet!", ex)
        }
    }

    private fun removeBossBar(player: Player) {
        try {
            val destroyPacket: Any = BossBarProviderImpl.Companion.PACKET_PLAY_OUT_ENTITY_DESTROY_CONSTRUCTOR.newInstance(*intArrayOf(witherId))
            PacketSender.sendPacket(player, destroyPacket)
            currentSecond.set(0)
        } catch (ex: Exception) {
            throw RuntimeException("Could not send wither entity destroy packet!", ex)
        }
    }

    init {
        currentSecond = AtomicInteger(0)
    }
}