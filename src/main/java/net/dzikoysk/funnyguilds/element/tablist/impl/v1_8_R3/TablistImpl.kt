package net.dzikoysk.funnyguilds.element.tablist.impl.v1_8_R3import

import com.google.common.collect.Lists
import net.dzikoysk.funnyguilds.FunnyGuilds
import net.dzikoysk.funnyguilds.basic.user.User
import net.dzikoysk.funnyguilds.element.tablist.AbstractTablist
import net.dzikoysk.funnyguilds.element.tablist.impl.v1_8_R3.TablistImpl
...
class TablistImpl(tablistPattern: Map<Int?, String?>?, header: String?, footer: String?, ping: Int, user: User?) : AbstractTablist(tablistPattern, header, footer, ping, user) {
    companion object {
        ...
        init {
            ...
            TablistImpl.Companion.ENUM_GAMEMODE_CLASS = Reflections.getNMSClass("WorldSettings\$EnumGamemode")
