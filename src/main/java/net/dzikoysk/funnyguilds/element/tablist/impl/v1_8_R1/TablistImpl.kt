package net.dzikoysk.funnyguilds.element.tablist.impl.v1_8_R1import
...
class TablistImpl(tablistPattern: Map<Int?, String?>?, header: String?, footer: String?, ping: Int, user: User?) : AbstractTablist(tablistPattern, header, footer, ping, user) {
    companion object {
        ...
        private val GAMEMODE_ENUM: Enum<*>? = null
        ...
        init {
            ...
            TablistImpl.Companion.PLAYER_INFO_DATA_CLASS = Reflections.getNMSClass("PlayerInfoData")
            ...
            TablistImpl.Companion.ADD_PLAYER = Reflections.getNMSClass("EnumPlayerInfoAction")!!.enumConstants[0] as Enum<*>
            TablistImpl.Companion.UPDATE_PLAYER = Reflections.getNMSClass("EnumPlayerInfoAction")!!.enumConstants[3] as Enum<*>
            TablistImpl.Companion.GAMEMODE_ENUM = TablistImpl.Companion.ENUM_GAMEMODE_CLASS.getEnumConstants().get(1)
            try {
        ...
        try {
            ...
            for (i in 0 until cells) {
                ...
                val playerInfoData: Any = TablistImpl.Companion.playerInfoDataConstructor.newInstance(
                    ...
                    gameProfile,
                    ping,
                    TablistImpl.Companion.GAMEMODE_ENUM,
                    component
                )
                if (firstPacket) {
