package net.dzikoysk.funnyguilds.element.tablist.variable.implimport
...
class GuildDependentTablistVariable(names: Array<String>, whenInGuild: Function<User?, Any?>, whenNotInGuild: Function<User?, Any?>) : TablistVariable {
    private val names: Array<String>
    private val whenInGuild: Function<User?, Any?>
    private val whenNotInGuild: Function<User?, Any?>

    constructor(name: String, whenInGuild: Function<User?, Any?>, whenNotInGuild: Function<User?, Any?>) : this(arrayOf<String>(name), whenInGuild, whenNotInGuild) {}
    ...
    override fun get(user: User): String? {
        return if (user.guild != null) Objects.toString(whenInGuild.apply(user)) else Objects.toString(whenNotInGuild.apply(user))
    }

    companion object {
        fun ofGuild(name: String, whenInGuild: Function<Guild?, Any?>, whenNotInGuild: Function<User?, Any?>?): GuildDependentTablistVariable {
            return GuildDependentTablistVariable(arrayOf(name), { user: User -> whenInGuild.apply(user.guild) }, whenNotInGuild)
        }
    }
