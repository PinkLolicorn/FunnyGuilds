package net.dzikoysk.funnyguilds.element.tablist.impl.v1_13_R2import

import com.google.common.collect.Lists
import net.dzikoysk.funnyguilds.FunnyGuilds
import net.dzikoysk.funnyguilds.basic.user.User
import net.dzikoysk.funnyguilds.element.tablist.AbstractTablist
import net.dzikoysk.funnyguilds.element.tablist.impl.v1_13_R2.TablistImpl
...
class TablistImpl(tablistPattern: Map<Int?, String?>?, header: String?, footer: String?, ping: Int, user: User?) : AbstractTablist(tablistPattern, header, footer, ping, user) {
    companion object {
        ...
        init {
            ...
            TablistImpl.Companion.HEADER_FIELD = Reflections.getField(TablistImpl.Companion.PLAYER_LIST_HEADER_FOOTER_CLASS, "header")
            TablistImpl.Companion.FOOTER_FIELD = Reflections.getField(TablistImpl.Companion.PLAYER_LIST_HEADER_FOOTER_CLASS, "footer")
        ...
        try {
            ...
            for (i in 0 until cells) {
                if (profileCache[i] == null) {
                    profileCache[i] = TablistImpl.Companion.gameProfileConstructor.newInstance(UUID.fromString(kotlin.String.format(TablistImpl.Companion.UUID_PATTERN, ChatUtils.appendDigit(i))), " ")
                }
