...
class SimpleTablistVariable(private val names: Array<String>, private val function: Function<User?, Any?>) : TablistVariable {
    constructor(name: String, function: Function<User?, Any?>) : this(arrayOf<String>(name), function) {}
    ...
    override fun get(user: User): String? {
        return Objects.toString(function.apply(user))
    }
}