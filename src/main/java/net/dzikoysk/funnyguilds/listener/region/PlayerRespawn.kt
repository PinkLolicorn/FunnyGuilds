...
class PlayerRespawn : Listener {
    ...
    fun onRespawn(event: PlayerRespawnEvent) {
        ...
        val home = user.guild!!.home ?: return
        event.respawnLocation = home
        if (config.createEntityType == null) {
            return
        }
        Bukkit.getScheduler().runTaskAsynchronously(FunnyGuilds.Companion.getInstance(), Runnable {
            val guildRegion = RegionUtils.getAt(home) ?: return@runTaskAsynchronously
            val guild = guildRegion.guild
