...
enum class NotePitch(val octave: Int, val tone: Note.Tone, val pitch: Float) {
    NOTE_1C(1, Note.Tone.C, 0.5f), NOTE_1D(1, Note.Tone.D, 0.53f), NOTE_1E(1, Note.Tone.E, 0.56f), NOTE_1F(1, Note.Tone.F, 0.6f), NOTE_1G(1, Note.Tone.G, 0.63f), NOTE_1A(
        1,
        Note.Tone.A,
        0.67f
    ),
    NOTE_1B(1, Note.Tone.B, 0.7f), NOTE_2C(2, Note.Tone.C, 0.76f), NOTE_2D(2, Note.Tone.D, 0.8f), NOTE_2E(2, Note.Tone.E, 0.84f), NOTE_2F(2, Note.Tone.F, 0.9f), NOTE_2G(
        2,
        Note.Tone.G,
        0.94f
    ),
    NOTE_2A(2, Note.Tone.A, 1.0f), NOTE_2B(2, Note.Tone.B, 1.06f), NOTE_C(3, Note.Tone.C, 1.12f), NOTE_D(3, Note.Tone.D, 1.18f), NOTE_E(3, Note.Tone.E, 1.26f), NOTE_F(3, Note.Tone.F, 1.34f), NOTE_G(
        3,
        Note.Tone.G,
        1.42f
    ),
    NOTE_A(3, Note.Tone.A, 1.5f), NOTE_B(3, Note.Tone.B, 1.6f), NOTE_4C(4, Note.Tone.C, 1.68f), NOTE_4D(4, Note.Tone.D, 1.78f), NOTE_4E(4, Note.Tone.E, 1.88f), NOTE_4F(4, Note.Tone.F, 2.0f);

    companion object {
        fun getPitch(octave: Int, tone: Note.Tone): Float {
            for (note in NotePitch.values()) {
        ...
        fun play(player: Player, octave: Int, tone: Note.Tone?) {
            var s: Sound? = null
            s = try {
            ...
            player.playSound(player.eyeLocation, s!!, 1f, NotePitch.Companion.getPitch(octave, tone))
        }
    }
}