package net.dzikoysk.funnyguilds.hook.worldeditimportimport
...
interface WorldEditHook {
    fun pasteSchematic(schematicFile: File, location: Location, withAir: Boolean): Boolean
    fun init()
}