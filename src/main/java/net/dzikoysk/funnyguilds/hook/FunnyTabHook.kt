package net.dzikoysk.funnyguilds.hookimport
...
object FunnyTabHook {
    fun initFunnyDisabler() {
        val logger: FunnyGuildsLogger = FunnyGuilds.Companion.getPluginLogger()
        logger.info("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
        ...
        logger.info("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
        Bukkit.getPluginManager().disablePlugin(FunnyGuilds.Companion.getInstance())
    }
}