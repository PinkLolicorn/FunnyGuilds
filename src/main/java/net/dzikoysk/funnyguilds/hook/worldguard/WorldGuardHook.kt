package net.dzikoysk.funnyguilds.hook.worldguardimport
...
interface WorldGuardHook {
    fun isInNonPointsRegion(location: Location?): Boolean
    fun isInIgnoredRegion(location: Location?): Boolean
    fun isInRegion(location: Location?): Boolean
    fun getRegionSet(location: Location?): ApplicableRegionSet?
    fun getRegionNames(location: Location?): List<String?>?
    fun init()
}